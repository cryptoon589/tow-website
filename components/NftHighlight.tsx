  ...
  return (
    <section className="py-16 md:py-24">
      <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
        <div className="mx-auto aspect-square w-full max-w-[420px] bg-gray-50 border-2 border-black rounded-lg overflow-hidden"><img src="/assets/nft/preview.png" alt="NFT" className="w-full h-full object-cover" onError={(e) => { (e.target as HTMLImageElement).style.display = "none"; }} /></div>
        <div>
